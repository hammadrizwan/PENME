...
def parse_args(argv=None):
    ...
    parser.add_argument(
        "--data_file",
        type=str,
        default="vector_data_files/counterfact_t5.jsonl",#add file path to vectors file
        help="dir to dataset",
    )
    ...
    parser.add_argument("--similatiry_thresh_codebook_stream", type=int, default= 4, help="tau adjustment")
    parser.add_argument("--path_to_codebook_stream", type=str, default= "trained_projectors/t5/t5_counterfact_codebook_stream.json", help="type of projector to use")
   
    parser.add_argument("--similatiry_thresh_codebook_batch", type=int, default= 5, help="tau adjustment")
    parser.add_argument("--path_to_codebook_batch", type=str, default= "trained_projectors/t5/t5_counterfact_codebook_batch.json", help="type of projector to use")
    #
    ##################################### Projector ############################################
    parser.add_argument("--force_train", type=bool, default= False, help="tau adjustment")# KEEP FALSE TO AVOID RETRAINING
    parser.add_argument("--pretrained_proj_path", type=str, default= "trained_projectors/t5/best_model_weights_counterfact_t5.pth", help="path to pretrained projector")
