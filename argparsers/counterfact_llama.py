...
def parse_args(argv=None):
    parser = argparse.ArgumentParser(description="Counterfact Editing Run on Llama-2-7b")
    ...
    parser.add_argument(
        "--data_file",
        type=str,
        default="vector_data_files/counterfact_llama.jsonl",#add file path to vectors file
        help="dir to dataset",
    )
    ...
    parser.add_argument("--path_to_codebook_stream", type=str, default= "trained_projectors/llama/Llama_counterfact_codebook_stream.json", help="type of projector to use")
    #
    # paired use
    parser.add_argument("--similatiry_thresh_codebook_batch", type=int, default= 14, help="tau adjustment")
